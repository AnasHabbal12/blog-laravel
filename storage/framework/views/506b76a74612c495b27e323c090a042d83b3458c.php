...
<body class="bg-gray-100 h-screen antialiased leading-none font-sans">
    <div id="app">
        <header class="bg-gray-700 py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <nav class="space-x-4 text-gray-300 text-sm sm:text-base">
                    <a href="/blog" class="text-lg font-semibold text-gray-100 no-underline">Blog</a>
        ...
        <div><?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
    </div>
</body>
</html>
